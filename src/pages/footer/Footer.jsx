...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover text-[#76ABAE]">Branding</a>
    <a className="link link-hover text-[#76ABAE]">Design</a>
    <a className="link link-hover text-[#76ABAE]">Marketing</a>
    <a className="link link-hover text-[#76ABAE]">Advertisement</a>
  </nav> 
  <nav>
    <h6 className="footer-title">Company</h6> 
    <a className="link link-hover text-[#76ABAE]">About us</a>
    <a className="link link-hover text-[#76ABAE]">Contact</a>
    <a className="link link-hover text-[#76ABAE]">Jobs</a>
    <a className="link link-hover text-[#76ABAE]">Press kit</a>
  </nav> 
  <nav>
    <h6 className="footer-title">Legal</h6> 
    <a className="link link-hover text-[#76ABAE]">Terms of use</a>
    <a className="link link-hover text-[#76ABAE]">Privacy policy</a>
    <a className="link link-hover text-[#76ABAE]">Cookie policy</a>
  </nav>
</footer> 
